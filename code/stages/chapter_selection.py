...
def chapter_selection_first_chapter(screen, screen_width, screen_height, font_big, font_small):
    chapter01 = pygame.image.load("images/ChapterSelection/Chapter01Bg.jpeg").convert()
    ...
    chapter01_button = pygame.image.load("images/ChapterSelection/ChapterSelection01Button.png").convert_alpha()
    chapter01_button_rect = chapter01_button.get_rect()
    chapter01_button_rect.top = 500
    chapter01_button_rect.left = 25

    chapter01_set_right = pygame.image.load("images/ChapterSelection/ChapterSelectionSetRight.png").convert_alpha()
...
def chapter_selection_second_chapter(screen, screen_width, screen_height, font_big, font_small):
    chapter02 = pygame.image.load("images/ChapterSelection/Chapter02Bg.png").convert()
    ...
    chapter02_set_left = pygame.image.load("images/ChapterSelection/ChapterSelectionSetLeft.png").convert_alpha()
